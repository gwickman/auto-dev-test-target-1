...
```bash
git checkout -b v002/01-string-utils/001-reverse
```
...
1. **Requirements:** `comms/inbox/versions/execution/v002/01-string-utils/001-reverse/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v002/01-string-utils/001-reverse/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v002/01-string-utils/001-reverse/`:
