...
```bash
git checkout -b v002/01-string-utils/002-truncate
```
...
**Feature:** 002-truncate

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v002/01-string-utils/002-truncate/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v002/01-string-utils/002-truncate/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v002/01-string-utils/002-truncate/`:
