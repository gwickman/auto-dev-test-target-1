...
```bash
git checkout -b v002/02-number-utils/002-round-to
```
...
**Feature:** 002-round-to

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v002/02-number-utils/002-round-to/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v002/02-number-utils/002-round-to/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v002/02-number-utils/002-round-to/`:
