...
```bash
git checkout -b v002/02-number-utils/001-clamp
```
...
1. **Requirements:** `comms/inbox/versions/execution/v002/02-number-utils/001-clamp/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v002/02-number-utils/001-clamp/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v002/02-number-utils/001-clamp/`:
