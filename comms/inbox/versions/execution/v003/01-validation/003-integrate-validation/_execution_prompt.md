...
```bash
git checkout -b v003/01-validation/003-integrate-validation
```
...
**Version:** v003
**Theme:** 01-validation
**Feature:** 003-integrate-validation

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v003/01-validation/003-integrate-validation/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v003/01-validation/003-integrate-validation/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v003/01-validation/003-integrate-validation/`:
