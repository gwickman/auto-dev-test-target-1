...
## Overview
Create AGENTS.md as the primary instruction document for Claude Code when working on this repository.

## Steps

### Step 1: Create AGENTS.md
Create AGENTS.md in project root with the following structure:
...
Ensure all sections are present and correctly formatted.

## Verification
- [ ] AGENTS.md exists at project root
- [ ] Contains PR workflow section
