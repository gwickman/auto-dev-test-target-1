...
```bash
git checkout -b v001/02-auto-dev-integration/001-agents-md
```
...
**Feature:** 001-agents-md

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v001/02-auto-dev-integration/001-agents-md/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v001/02-auto-dev-integration/001-agents-md/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v001/02-auto-dev-integration/001-agents-md/`:
