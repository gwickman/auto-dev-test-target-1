...
```bash
git checkout -b v001/01-project-scaffold/001-package-and-typescript
```
...
**Feature:** 001-package-and-typescript

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v001/01-project-scaffold/001-package-and-typescript/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v001/01-project-scaffold/001-package-and-typescript/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v001/01-project-scaffold/001-package-and-typescript/`:
