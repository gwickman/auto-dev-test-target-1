...
```bash
git checkout -b v001/01-project-scaffold/002-jest-config
```
...
**Feature:** 002-jest-config

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v001/01-project-scaffold/002-jest-config/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v001/01-project-scaffold/002-jest-config/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v001/01-project-scaffold/002-jest-config/`:
