...
```bash
git checkout -b v001/01-project-scaffold/003-ci-workflow
```
...
1. **Requirements:** `comms/inbox/versions/execution/v001/01-project-scaffold/003-ci-workflow/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v001/01-project-scaffold/003-ci-workflow/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v001/01-project-scaffold/003-ci-workflow/`:
