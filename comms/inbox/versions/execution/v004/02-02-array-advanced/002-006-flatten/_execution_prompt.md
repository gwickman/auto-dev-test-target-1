...
```bash
git checkout -b v004/02-02-array-advanced/002-006-flatten
```
...
**Feature:** 002-006-flatten

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v004/02-02-array-advanced/002-006-flatten/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v004/02-02-array-advanced/002-006-flatten/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v004/02-02-array-advanced/002-006-flatten/`:
