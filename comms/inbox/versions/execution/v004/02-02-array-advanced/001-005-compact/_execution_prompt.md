...
```bash
git checkout -b v004/02-02-array-advanced/001-005-compact
```
...
**Feature:** 001-005-compact

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v004/02-02-array-advanced/001-005-compact/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v004/02-02-array-advanced/001-005-compact/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v004/02-02-array-advanced/001-005-compact/`:
