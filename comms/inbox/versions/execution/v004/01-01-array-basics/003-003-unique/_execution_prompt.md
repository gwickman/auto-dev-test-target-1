...
```bash
git checkout -b v004/01-01-array-basics/003-003-unique
```
...
**Feature:** 003-003-unique

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v004/01-01-array-basics/003-003-unique/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v004/01-01-array-basics/003-003-unique/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v004/01-01-array-basics/003-003-unique/`:
