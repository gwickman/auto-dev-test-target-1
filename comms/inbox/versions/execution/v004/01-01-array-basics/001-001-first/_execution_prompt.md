...
```bash
git checkout -b v004/01-01-array-basics/001-001-first
```
...
**Feature:** 001-001-first

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v004/01-01-array-basics/001-001-first/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v004/01-01-array-basics/001-001-first/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v004/01-01-array-basics/001-001-first/`:
