...
```bash
git checkout -b v004/01-01-array-basics/002-002-last
```
...
**Feature:** 002-002-last

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v004/01-01-array-basics/002-002-last/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v004/01-01-array-basics/002-002-last/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v004/01-01-array-basics/002-002-last/`:
