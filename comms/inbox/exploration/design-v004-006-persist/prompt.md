...
Create findings in `comms/outbox/exploration/design-v004-006-persist/`:
...
- [ ] `comms/inbox/versions/execution/v004/VERSION_DESIGN.md` exists
- [ ] `comms/inbox/versions/execution/v004/THEME_INDEX.md` exists
- [ ] `comms/inbox/versions/execution/v004/01-theme-name/THEME_DESIGN.md` exists
- [ ] `comms/inbox/versions/execution/v004/01-theme-name/001-feature/requirements.md` exists
- [ ] `comms/inbox/versions/execution/v004/01-theme-name/001-feature/implementation-plan.md` exists
...
```bash
git add comms/outbox/exploration/design-v004-006-persist/
git commit -m "exploration: design-v004-006-persist - documents persisted to inbox"
git push
```