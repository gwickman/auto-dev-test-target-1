...
Create findings in `comms/outbox/exploration/design-v004-003-research/`:
...
```bash
git add comms/outbox/exploration/design-v004-003-research/
git commit -m "exploration: design-v004-003-research - research and investigation complete"
git push
```