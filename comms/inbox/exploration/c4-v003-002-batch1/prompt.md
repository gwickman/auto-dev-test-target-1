# Task 002: Code-Level Analysis (Batch 1)

Read AGENTS.md first and follow all instructions there.

## Objective

Analyze the source code in each assigned directory and produce C4 Code-level documentation files. This is batch 1 of 1 — this batch processes all directories.

## Context

C4 architecture documentation generation for `auto-dev-test-target-1` version `v003`.
- **Batch:** 1 of 1
...
Save outputs to `comms/outbox/exploration/c4-v003-002-batch1/`:
