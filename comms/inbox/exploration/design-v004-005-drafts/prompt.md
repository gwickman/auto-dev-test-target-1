...
This is Phase 2 (Document Drafts) for `auto-dev-test-target-1` version `v004`.
...
Create findings in `comms/outbox/exploration/design-v004-005-drafts/`:
...
```bash
git add comms/outbox/exploration/design-v004-005-drafts/
git commit -m "exploration: design-v004-005-drafts - document drafts complete"
git push
```