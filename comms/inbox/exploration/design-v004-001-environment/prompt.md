...
This is the first step in a multi-phase version design process for `auto-dev-test-target-1` version `v004`.
...
Run `get_project_info(project="auto-dev-test-target-1")` and verify:
